  ...
  init : function() {
    ...
    $('#main-navbar').on("click", ".navlinks-parent", function(e) {
      ...
      $.each($(".navlinks-parent"), function(key, value) {
        if (value == target) {$(value).parent().toggleClass("show-children");
        } else { $(value).parent().removeClass("show-children"); }
      });
    });
		  ...
		  // set an initial image
			...
			var getNextImg = function() {
				...
				setTimeout(function(){
					...
					setTimeout(function() {main.setImg(src, desc);img.remove();getNextImg();}, 1000);
				}, 6000);
			};
			// If there are multiple images, cycle through them
			if (main.numImgs > 1) {getNextImg();}
    }
  },
  getImgInfo : function() {
